...
const useStyles = createStyles((theme, params: { disabled?: boolean; readOnly?: boolean }) => ({
  ...
  label: {
    width: '100%',
    color: params.disabled ? "rgb(225 225 225 / 40%)" : theme.colors.dark[0],
    whiteSpace: 'pre-wrap',
  },
  button: {
    height: 'fit-content',
    ...
    padding: 10,
    '&:hover': {
      backgroundColor: params.readOnly ? "rgb(225 225 225 / 40%)" : undefined,
  ...
  description: {
    color: params.disabled ? "rgb(225 225 225 / 40%)" : theme.colors.dark[2],
    fontSize: 12,
  },
  dropdown: {
    padding: 10,
